(() => {
  ...
  window.addEventListener("load", function (e) {
    de(),
      document.querySelector(".sell__slider") &&
        new ae(".sell__slider", {
          modules: [oe, le],
          effect: "fade",
          ...
          loop: !0,
          navigation: {
            nextEl: ".sell__navigation_right",
            prevEl: ".sell__navigation_left",
          },
          breakpoints: {
            320: { slidesPerView: 1.15, spaceBetween: 5, autoHeight: !0 },
      ...
      document.querySelector(".feature__slider") &&
        new ae(".feature__slider", {
          modules: [oe],
          observer: !0,
          observeParents: !0,
          slidesPerView: 4,
          ...
          loop: !0,
          navigation: {
            nextEl: ".feature__navigation_right",
            prevEl: ".feature__navigation_left",
          },
          breakpoints: {
            320: { slidesPerView: 1.1, spaceBetween: 5, autoHeight: !0 },
            400: { slidesPerView: 1.4, spaceBetween: 10, autoHeight: !0 },
            550: { slidesPerView: 2, spaceBetween: 15, autoHeight: !0 },
            992: { slidesPerView: 3, spaceBetween: 15 },
            1450: { slidesPerView: 4, spaceBetween: 22 },
          },
          on: {},
        }),
      document.querySelector(".latest__slider") &&
        new ae(".latest__slider", {
          modules: [oe],
          observer: !0,
          observeParents: !0,
          slidesPerView: 4,
          ...
          loop: !0,
          navigation: {
            nextEl: ".latest__navigation_right",
            prevEl: ".latest__navigation_left",
          },
          breakpoints: {
            320: { slidesPerView: 1.1, spaceBetween: 5, autoHeight: !0 },
            400: { slidesPerView: 1.4, spaceBetween: 10, autoHeight: !0 },
      ...
      document.querySelector(".seller__slider") &&
        new ae(".seller__slider", {
          modules: [oe],
          observer: !0,
          observeParents: !0,
          slidesPerView: 4,
          ...
          loop: !0,
          navigation: {
            nextEl: ".seller__navigation_right",
            prevEl: ".seller__navigation_left",
          },
          breakpoints: {
            320: { slidesPerView: 1.1, spaceBetween: 5, autoHeight: !0 },
            400: { slidesPerView: 1.4, spaceBetween: 10, autoHeight: !0 },
    ...
    (window.onload = function () {
      document.addEventListener("click", function (e) {
        ...
        t.classList.contains("search-header__icon")
          ...
          : !t.closest(".search-header__form") &&
            document.querySelectorAll(".search-header__form._active").length >
              0 &&
            (function (e, t) {
              for (var s = 0; s < e.length; s++) e[s].classList.remove(t);
            })(
              document.querySelectorAll(".search-header__form._active"),
              "_active"
            );
      });
    }),
